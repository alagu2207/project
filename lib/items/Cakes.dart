...
class Cakes extends StatefulWidget {
  ...
  const Cakes({super.key, required this.userDetails});
...
class _CakesState extends State<Cakes> {
  ...
  Future<void> fetchProducts() async {
    const String apiUrl =
        'https://673f182fa9bc276ec4b722c5.mockapi.io/Products?items=cakes';
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(    backgroundColor: const Color(0xFFFC0500),
        title: const Text("Cakes",style: const TextStyle(
                          ...
                          child: Row(
                            children: [
                              ...
                              Data(
                                ...
                                initialRating:
                                    _products[firstProductIndex].initialRating,
                                id: _products[firstProductIndex].id,
                              ),
                              ...
                              if (secondProductIndex < _products.length)
                                Data(
                                  ...
                                  initialRating: _products[secondProductIndex]
                                      .initialRating,
                                  id: _products[secondProductIndex].id,
                                ),
                            ],
                          ),
                        );
